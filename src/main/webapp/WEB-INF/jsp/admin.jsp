...
<head>
  ...
  <link rel="stylesheet" href="/static/backstage/css/global.css">
  <link rel="stylesheet" href="/static/backstage/icheck/minimal/red.css">
</head>
<body class="layui-layout-body">
<div class="layui-layout layui-layout-admin">
  <div class="layui-header">
    <div class="layui-logo">YLaSour</div>
    <!-- 头部区域（可配合layui已有的水平导航） -->
    <ul class="layui-nav layui-layout-left">
      <li class="layui-nav-item"><a href="/admin.do">用户列表</a></li>
      <li class="layui-nav-item"><a href="/member.do">会员列表</a></li>
    </ul>
  ...
  <div class="layui-side layui-bg-black">
    <div class="layui-side-scroll">
      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        <li class="layui-nav-item"><a href="/index.do">控制台</a></li>
        <li class="layui-nav-item">
        ...
        <li class="layui-nav-item layui-nav-itemed">
          ...
          <dl class="layui-nav-child">
            <dd><a class="layui-this" href="/admin.do">用户列表</a></dd>
          </dl>
        </li>
        <li class="layui-nav-item">
            <a href="javascript:;">权限管理</a>
            <dl class="layui-nav-child">
                <dd><a href="rule.do">规则列表</a></dd>
                <dd><a href="role.do">角色列表</a></dd>
                <dd><a href="adminRole.do">用户角色</a></dd>
            </dl>
        </li>
        <li class="layui-nav-item">
...
<script type="text/javascript" src="/static/backstage/icheck/icheck.js"></script>
<script type="text/javascript" src="/static/backstage/javascript/dw.js"></script>
</body>
</html>